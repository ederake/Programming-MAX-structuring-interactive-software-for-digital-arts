...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 326.0, 79.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1114.0, 340.0, 104.0, 22.0 ],
					"style" : "",
					"text" : "32, 53, 60, 89, 74"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 999.0, 340.0, 104.0, 22.0 ],
					"style" : "",
					"text" : "46, 65, 60, 67, 77"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 712.5, 201.0, 71.0, 22.0 ],
					"style" : "",
					"text" : "counter 1 5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 89.0, 227.0, 71.0, 22.0 ],
					"style" : "",
					"text" : "counter 1 5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1033.0, 770.0, 52.0, 49.0 ],
					"style" : "",
					"text" : "done 6 blading.mov"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 257.0, 122.0, 71.0, 22.0 ],
					"style" : "",
					"text" : "counter 1 8"
				}
...
,
					"patching_rect" : [ 833.0, 29.0, 337.0, 113.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 40.0, 482.0, 22.0, 140.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 89.0, 103.0, 55.0, 60.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 549.0, 457.5, 51.0, 22.0 ],
					"style" : "",
					"text" : "rate 1.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 194.0, 287.0, 128.0, 22.0 ],
					"style" : "",
					"text" : "4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 869.0, 340.0, 104.0, 22.0 ],
					"style" : "",
					"text" : "46, 53, 60, 67, 74"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 753.5, 340.0, 104.0, 22.0 ],
					"style" : "",
					"text" : "50, 60, 63, 69, 77"
				}
...
,
					...
					"patching_rect" : [ 97.0, 381.5, 145.0, 111.5 ],
					"style" : ""
				}
...
,
					...
					"patching_rect" : [ 283.0, 505.5, 344.0, 232.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 283.0, 758.0, 640.0, 480.0 ],
